...
document.querySelectorAll(".column").forEach((e) => {
    e.addEventListener("click", () => {
        ...
        if (sum <= 6 && turn % 2 != 0) {
            ...
            document.getElementById("whosturn").style.backgroundColor = "rgb(74, 74, 198)";
            document.getElementById("whosturn").style.color = "yellow";
            ...
            document.getElementById("whosturn").style.backgroundColor = "rgb(74, 74, 198)";
            document.getElementById("whosturn").style.color = "red";
